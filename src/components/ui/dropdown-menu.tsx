...
function DropdownMenuContent({
    ...
    sideOffset = 4,
    ...props
}: React.ComponentProps<typeof DropdownMenuPrimitive.Content> & { surface?: "glass" | "solid" }) {
    return (
...
function DropdownMenuSubContent({
    ...
    return (
        <DropdownMenuPrimitive.SubContent
            ...
            className={cn(
                surface === "glass" ? "glass-popover" : "bg-popover shadow-lg",
                "data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 data-[side=bottom]:slide-in-from-top-2 data-[side=left]:slide-in-from-right-2 data-[side=right]:slide-in-from-left-2 data-[side=top]:slide-in-from-bottom-2 z-[70] max-h-(--radix-dropdown-menu-content-available-height) min-w-[8rem] origin-(--radix-dropdown-menu-content-transform-origin) overflow-y-auto overflow-x-hidden rounded-[var(--radius-lg)] border p-1 text-popover-foreground data-[state=closed]:animate-out data-[state=open]:animate-in max-sm:data-[side=left]:ml-[75%] max-sm:data-[side=right]:-ml-[75%]",
                className
            )}
            {...props}
        />
