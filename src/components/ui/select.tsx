...
function SelectContent({
    ...
    position = "popper",
    ...props
}: React.ComponentProps<typeof SelectPrimitive.Content> & { surface?: "glass" | "solid" }) {
    return (
