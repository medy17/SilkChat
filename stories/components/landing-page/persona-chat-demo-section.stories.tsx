...
import { PersonaChatDemoSection } from "@/components/landing-page/persona-chat-demo-section"
import "../../../.storybook/landing.css"

const meta = {
    title: "Landing/PersonaChatDemoSection",
    component: PersonaChatDemoSection,
    parameters: {
        layout: "fullscreen",
        docs: {
            description: {
...
} satisfies Meta<typeof PersonaChatDemoSection>
export default meta
