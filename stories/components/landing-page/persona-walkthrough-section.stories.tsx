...
import { PersonaWalkthroughSection } from "@/components/landing-page/persona-walkthrough-section"
import "../../../.storybook/landing.css"

const meta = {
    title: "Landing/PersonaWalkthroughSection",
    component: PersonaWalkthroughSection,
    parameters: {
        layout: "fullscreen",
        docs: {
            description: {
...
} satisfies Meta<typeof PersonaWalkthroughSection>
export default meta
